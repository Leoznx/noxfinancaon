...
export const InstitutionalHero = () => (
  <section className="relative w-full overflow-hidden bg-white lg:min-h-[620px] xl:min-h-[650px]">
    {/* Fundo: foto + degradÃªs em camadas */}
    <div className="absolute inset-0">
      ...
      <img
        ...
        alt="Chaveiro NOX em frente a um imÃ³vel moderno"
        loading="eager"
        decoding="async"
        fetchPriority="high"
        className="h-full w-full object-cover object-center lg:object-contain lg:object-right-bottom"
      />
      {/* DegradÃª branco -> transparente, da esquerda para a direita */}
      <div
      ...
      />
      {/* ReforÃ§o de legibilidade sÃ³ no mobile, onde nÃ£o hÃ¡ coluna dedicada ao texto */}
    ...
    <div className="relative px-5 pb-16 pt-28 sm:px-10 sm:pb-24 sm:pt-40 lg:flex lg:min-h-[620px] lg:items-center lg:pb-14 lg:pl-[11vw] lg:pr-16 lg:pt-24 xl:min-h-[650px] xl:pl-[12vw] xl:pr-24 xl:pt-28 2xl:pl-[13vw] 2xl:pr-28">
      <div className="max-w-[590px] xl:max-w-[620px]">
        ...
        <h1 className="text-3xl sm:text-4xl md:text-[2.7rem] lg:text-[3.35rem] xl:text-[3.65rem] font-bold text-neutral-900 leading-[1.08] tracking-tight mb-6 sm:mb-7">
          Aluguel sem fiador, sem cauÃ§Ã£o, com aprovaÃ§Ã£o em atÃ© <span className="relative inline-block">
        ...
        <p className="text-base sm:text-lg md:text-xl text-neutral-600 mb-8 sm:mb-8 max-w-[520px] leading-relaxed">
          A NOX FIANÃ‡A Ã© a plataforma de seguro fianÃ§a 100% digital que elimina a burocracia do aluguel e oferece seguranÃ§a total ao proprietÃ¡rio.
        </p>
        <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 mb-10 sm:mb-9">
          ...
          <Link to="/cadastro" className="w-full sm:w-auto">
            <Button variant="outline" className="w-full sm:w-auto min-h-[44px] h-12 px-6 sm:px-7 border-neutral-300 text-neutral-900 hover:bg-neutral-50 text-sm sm:text-base font-medium rounded-lg">
              Sou imobiliÃ¡ria ou corretor
            </Button>
          </Link>
        </div>
        <div className="flex flex-wrap gap-4 sm:gap-8">
          {['Sem fiador', 'Sem cauÃ§Ã£o', 'AprovaÃ§Ã£o em 1 minuto', '100% digital'].map(item => (
...
export const SocialProofLogos = () => {
  const partners = [
    { name: "Cordeiro ImÃ³veis", style: "font-sans font-bold", icon: () => (
    ...
    { name: "VÃ©rtice ImobiliÃ¡ria", style: "font-serif font-semibold italic", icon: () => (
    ...
    { name: "Boreal ImÃ³veis", style: "font-sans lowercase font-light", icon: () => (
    ...
    { name: "Premier ImobiliÃ¡ria", style: "font-serif italic", icon: () => (
    ...
    { name: "Norte Sul ImÃ³veis", style: "font-sans font-medium tracking-tighter", icon: () => (
    ...
    { name: "ConexÃ£o ImobiliÃ¡ria", style: "font-sans", icon: () => (
    ...
    { name: "Verde ImÃ³veis", style: "font-serif font-medium", icon: () => (
    ...
    { name: "Reserva ImobiliÃ¡ria", style: "font-sans uppercase font-bold tracking-[0.2em]", icon: () => (
    ...
    <section className="py-12 sm:py-16 bg-white border-y border-neutral-100 relative overflow-hidden group/section">
      ...
      <div className="container mx-auto px-4 sm:px-6 mb-10 sm:mb-12 text-center">
        <p className="text-neutral-400 font-bold uppercase tracking-[0.2em] text-[10px]">
          MAIS DE 500 IMOBILIÃRIAS CONFIAM NA NOX FIANÃ‡A
        </p>
      </div>
    ...
    <div className="container mx-auto max-w-7xl grid lg:grid-cols-2 gap-10 lg:gap-16 items-center">
      ...
      <div>
        ...
        <div className="space-y-5 sm:space-y-6 text-neutral-600 text-base sm:text-lg leading-relaxed">
          <p>
            O seguro fianÃ§a da NOX foi desenvolvido para simplificar a jornada de locaÃ§Ã£o, eliminando a necessidade de garantias tradicionais e burocrÃ¡ticas que travam o mercado imobiliÃ¡rio.
          </p>
          <p>
            Nossa plataforma utiliza tecnologia proprietÃ¡ria para realizar anÃ¡lises de crÃ©dito precisas e instantÃ¢neas, proporcionando agilidade para o inquilino e seguranÃ§a inabalÃ¡vel para o proprietÃ¡rio do imÃ³vel.
          </p>
        </div>
        <Link to="/corretor">
