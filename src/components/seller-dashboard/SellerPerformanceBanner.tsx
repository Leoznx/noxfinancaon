...
export function SellerPerformanceBanner({
  ...
  return (
    <section className="relative min-h-[150px] overflow-hidden rounded-2xl border border-neutral-200 bg-[linear-gradient(100deg,#fff7d6_0%,#ffffff_48%,#fffcef_100%)] px-5 py-4 shadow-[0_1px_4px_rgba(0,0,0,0.03)] sm:px-7 lg:px-6 xl:h-full xl:min-h-0 xl:px-5 xl:py-2.5">
      <div className="relative grid min-h-[108px] items-center gap-5 xl:h-full xl:min-h-0 xl:grid-cols-[minmax(330px,0.82fr)_minmax(0,1.28fr)] xl:gap-4">
        <div className="flex min-w-0 items-center justify-center overflow-hidden xl:justify-start">
          <img
            ...
            className="h-auto max-h-[132px] w-full max-w-[540px] object-contain object-center xl:max-h-[94px] xl:object-left"
          />
        </div>
