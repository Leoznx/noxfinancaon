...
const corretorSchema = z
  ...
  .refine(
    (data) => data.vinculadoImobiliaria === "nao" || !!data.imobiliariaIdentificador?.trim(),
    {
...
const proprietarioSchema = z
  .object({
    ...
    cpfCnpj: z
      .string()
      .refine((val) => validateCPF(val) || validateCNPJ(val), "Documento inválido"),
    email: z.string().email("E-mail inválido"),
    telefone: z.string().min(14, "Telefone inválido"),
    cidade: z.string().min(2, "Cidade é obrigatória"),
    estado: z.string().length(2, "Selecione o estado"),
  ...
  const onSubmit = async (data: any) => {
    ...
    try {
      ...
      if (accountType === "inquilino") {
        ...
        if (!result.ok) {
          toast.error("Não foi possível criar a conta com os dados informados.");
      ...
      try {
        ...
        if (refCode) {
          ...
          if (indicador && indicador.id !== userId) {
            ...
            const sameDocOrEmail = await supabase
              .from("profiles")
              .select("id")
              .or(`email.eq.${referredEmail}`)
              .neq("id", userId)
              .limit(1);
      ...
      <div className="min-h-screen flex flex-col items-center justify-center bg-neutral-50 p-6 text-center">
        ...
        <div className="max-w-md text-neutral-600 space-y-4 mb-10">
          <p>
            ...
            <strong className="text-neutral-900">{successEmail}</strong>. Clique nele para ativar
            sua conta — você será redirecionado automaticamente para a Home já conectado.
          </p>
    ...
    return (
      <div className="min-h-screen flex flex-col items-center justify-center bg-neutral-50 p-6 text-center">
        ...
        <div className="max-w-md text-neutral-600 space-y-4 mb-10">
          <p>
            Enviamos um link de confirmação para{" "}
            <strong className="text-neutral-900">{successEmail}</strong> — confirme seu e-mail
            primeiro. Depois disso, sua solicitação entra em análise pela nossa equipe, e você
            recebe um aviso em até 24 horas úteis confirmando a liberação do seu acesso.
          </p>
          <p className="text-sm italic">
            Enquanto isso, fique à vontade para conhecer nossos planos e materiais para
            imobiliárias.
          </p>
        </div>
        <div className="flex flex-col sm:flex-row items-center gap-3">
  ...
  return (
    <div className="min-h-screen bg-neutral-50 flex flex-col">
      <header className="px-6 py-4 flex items-center justify-between container mx-auto max-w-7xl">
        ...
        <Link
          to="/login"
          className="text-sm font-black text-neutral-900 hover:text-yellow-600 flex items-center gap-1.5 transition-colors"
        >
        ...
        <div className="w-full max-w-5xl">
          {routedPerfil && (
            <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-3 mb-6 text-sm text-neutral-700 flex items-start gap-2 max-w-xl mx-auto animate-in fade-in zoom-in duration-500">
              ...
              <div>
                <p className="font-black text-neutral-900 uppercase text-[10px] tracking-widest mb-0.5">
                  Quase lá!
                </p>
                <p className="text-xs font-medium">
                  Você está criando sua conta de {PERFIL_LABELS[routedPerfil]}.
                </p>
              </div>
            </div>
          )}
          {returnTo === "/simular/resultado" && !routedPerfil && (
            <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-3 mb-6 text-sm text-neutral-700 flex items-start gap-2 max-w-xl mx-auto">
              ...
              <div>
                ...
                <p className="text-xs">
                  Crie sua conta para ver os planos disponíveis para o cliente.
                </p>
              </div>
            </div>
          )}
          {step === 1 ? (
            <div className="text-center">
              ...
              <p className="text-sm text-neutral-500 mb-8">
                Escolha o perfil que melhor descreve sua atuação.
              </p>
              ...
              <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4">
                ...
                >
                  <CardContent className="p-3 sm:p-6 flex flex-col items-start text-left">
                    ...
                    <p className="text-[11px] sm:text-xs text-neutral-600 leading-snug sm:leading-relaxed">
                      Quero acessar meus seguros, documentos, boletos e faturas vinculados ao meu
                      CPF.
                    </p>
                  </CardContent>
                </Card>
                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                            ...
                            {accountType === "imobiliaria" ? (
                              <>
                                ...
                                <Input
                                  ...
                                  onChange={(e) =>
                                    formImobiliaria.setValue("cnpj", maskCNPJ(e.target.value))
                                  }
                                />
                                {errors.cnpj && (
                                  <p className="text-[10px] text-red-500 -mt-3">
                              ...
                              <>
                                ...
                                <Input
                                  ...
                                  onChange={(e) =>
                                    formCorretor.setValue("cpf", maskCPF(e.target.value))
                                  }
                                />
                                {errors.cpf && (
                                  <p className="text-[10px] text-red-500 -mt-3">
                                ...
                                <Input
                                  ...
                                  onChange={(e) =>
                                    formCorretor.setValue("telefone", maskPhone(e.target.value))
                                  }
                                />
                                {errors.telefone && (
                                  <p className="text-[10px] text-red-500 -mt-3">
                              ...
                              <>
                                ...
                                <Input
                                  ...
                                  placeholder="(00) 00000-0000"
                                  onChange={(e) =>
                                    formProprietario.setValue("telefone", maskPhone(e.target.value))
                                  }
                                />
                                {errors.telefone && (
                                  <p className="text-[10px] text-red-500 -mt-3">
                            ...
                            {accountType === "imobiliaria" ? (
                              <>
                                ...
                                <Input
                                  ...
                                  placeholder="(00) 00000-0000"
                                  onChange={(e) =>
                                    formImobiliaria.setValue("telefone", maskPhone(e.target.value))
                                  }
                                />
                                {errors.telefone && (
                                  <p className="text-[10px] text-red-500 -mt-3">
                              ...
                              <>
                                <div className="space-y-1">
                                  ...
                                  <Select
                                    onValueChange={(val: "sim" | "nao") => {
                                      formCorretor.setValue("vinculadoImobiliaria", val, {
                                        shouldValidate: true,
                                      });
                                      if (val === "nao") {
                                        formCorretor.setValue("imobiliariaIdentificador", "", {
                                          shouldValidate: true,
                                        });
                                      }
                                    }}
                                ...
                                {formCorretor.watch("vinculadoImobiliaria") === "sim" && (
                                  <div className="space-y-1">
                                    ...
                                    <p className="text-[10px] text-neutral-500">
                                      Informe o CNPJ ou o e-mail já cadastrado da imobiliária para
                                      vincular sua conta a ela.
                                    </p>
                                    {errors.imobiliariaIdentificador && (
                                      <p className="text-[10px] text-red-500">
                                        {errors.imobiliariaIdentificador.message}
                                      </p>
                                    )}
                                  </div>
                                )}
                              ...
                              <>
                                ...
                                <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-3 text-xs text-neutral-700 mt-2">
                                  ...
                                  <p>
                                    Dados bancários para repasse de comissões serão solicitados após
                          ...
                          <div className="space-y-4">
                              ...
                              <div className="flex gap-1">
                                <div
                                  className={cn(
                                    ...
                                    activeForm.watch("senha")?.length >= 1
                                      ? "bg-yellow-400"
                                      : "bg-neutral-200",
                                  )}
                                ></div>
                                <div
                                  className={cn(
                                    "h-1 flex-1 rounded-full",
                                    activeForm.watch("senha")?.length >= 4
                                      ? "bg-yellow-400"
                                      : "bg-neutral-200",
                                  )}
                                ></div>
                                <div
                                  className={cn(
                                    "h-1 flex-1 rounded-full",
                                    activeForm.watch("senha")?.length >= 6
                                      ? "bg-yellow-400"
                                      : "bg-neutral-200",
                                  )}
                                ></div>
                                <div
                                  className={cn(
                                    "h-1 flex-1 rounded-full",
                                    activeForm.watch("senha")?.length >= 12
                                      ? "bg-yellow-400"
                                      : "bg-neutral-200",
                                  )}
                                ></div>
                            ...
                            <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-3 text-[10px] text-neutral-700">
                              Mínimo 12 caracteres, com letras maiúsculas, minúsculas e número.
                            </div>
                          </div>
                        </div>
                        ...
                        <div className="mt-8 pt-6 border-t border-neutral-200 flex flex-col sm:flex-row items-center justify-between gap-4">
                          <div className="flex items-start space-x-2">
                            ...
                            <div className="grid gap-1">
                              <label
                                htmlFor="termos"
                                className="text-xs font-medium leading-none text-neutral-700"
                              >
                                Aceito os{" "}
                                <Link to="/termos" className="text-yellow-600 underline">
                                  Termos de Uso
                                </Link>{" "}
                                e a{" "}
                                <Link to="/privacidade" className="text-yellow-600 underline">
  ...
  return (
    <form onSubmit={form.handleSubmit(onSubmit)} className="max-w-xl mx-auto space-y-4">
      <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-3 text-xs text-neutral-700">
        Vamos vincular automaticamente todos os contratos, faturas e documentos cadastrados com o
        seu CPF.
      </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
        ...
        <div className="space-y-1">
          ...
          {errors.confirmarSenha && (
            <p className="text-[10px] text-red-500">{errors.confirmarSenha.message}</p>
          )}
        </div>
      </div>
      ...
      {errors.termos && (
        <p className="text-[10px] text-red-500">Você deve aceitar para continuar</p>
      )}
