...
import noxFianca3d from "@/assets/nox-fianca-3d.png";
...
function DemoAccountsPage() {
  ...
  return (
    <DashboardLayout>
      <div className="mx-auto w-full max-w-[1060px] space-y-5 pb-10">
        <section className="grid overflow-hidden rounded-[26px] border border-neutral-200 bg-white shadow-[0_14px_42px_rgba(0,0,0,0.05)] lg:grid-cols-[minmax(0,1fr)_280px]">
          ...
          <div className="relative flex min-h-[150px] flex-col justify-between overflow-hidden border-t border-neutral-200 bg-yellow-300 p-6 lg:border-l lg:border-t-0">
            ...
            <div className="relative z-10 flex items-end gap-3 pr-20">
            ...
            <img
              ...
              alt=""
              aria-hidden="true"
              className="absolute -bottom-5 -right-3 h-28 w-28 object-contain drop-shadow-[0_12px_14px_rgba(77,52,0,0.24)]"
            />
          </div>
        </section>

        <div className="grid items-start gap-5 lg:grid-cols-[minmax(0,730px)_290px] lg:justify-center">
              ...
              {DEMO_PROFILE_KEYS.map((profileKey) => {
                ...
                return (
                  <button
                    ...
                    className="group flex min-h-[250px] flex-col rounded-[20px] border border-neutral-200 bg-white p-4 text-left transition duration-200 hover:-translate-y-1 hover:border-yellow-400 hover:shadow-[0_14px_30px_rgba(0,0,0,0.08)] focus:outline-none focus-visible:ring-2 focus-visible:ring-yellow-400 sm:aspect-square"
                  >
                    <div className="flex items-center gap-3.5">
                      <span className="flex h-16 w-16 shrink-0 items-center justify-center rounded-[20px] bg-[#eef1f6] shadow-[7px_10px_22px_rgba(15,23,42,0.16),inset_0_1px_0_rgba(255,255,255,0.9)] transition duration-200 group-hover:-translate-y-0.5 group-hover:bg-white group-hover:shadow-[8px_13px_25px_rgba(15,23,42,0.2)]">
                        <Icon className="h-9 w-9 text-neutral-950" strokeWidth={2} />
                      </span>
                      <div className="min-w-0">
                        <h3 className="text-lg font-black tracking-[-0.025em] text-neutral-950">
                          {profile.label}
                        </h3>
                    ...
                    <p className="mt-4 text-xs font-medium leading-5 text-neutral-600">
                    ...
                    <div className="mt-3 flex flex-wrap gap-1.5">
                      {presentation.highlights.map((highlight) => (
                        <span
                          key={highlight}
                          className="rounded-full border border-neutral-200 px-2 py-1 text-[8px] font-black uppercase tracking-[0.09em] text-neutral-500"
                        >
                          {highlight}
                        </span>
                      ))}
                    ...
                    <span className="mt-auto flex items-center justify-between border-t border-neutral-200 pt-3 text-[11px] font-black text-neutral-950">
